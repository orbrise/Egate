                ...
                <div id="page-content">
                    ...
                    <div class="content-header">
                        <div class="header-section">
                            <h1>
                                <i class="gi gi-notes_2"></i>Receipts -Post Date Cheque Request Form<br/><small></small>
                            </h1>
                        </div>
                    </div>
                    <ul class="breadcrumb breadcrumb-top">
                        <li><a href="finance.php">Finance</a></li>
                        <li><a href="">Receipts -Post Date Cheque Request Form</a></li>
                    </ul>
...
$r=rand();
	...
	$form_name='Receipts -Post Date Cheque Request Form';
    ...
    $insform=mysql_query("insert into formsdata (id,username,ref,created_date,benif_name,amount,invoice,due_date,description,entry_date,entry_time,Ip,status,formid,payc,inv_date,total_cost,cus_name,check_no,check_amount,inv_amt,form_name) values
	                                ('','$requester','$ref','$created_date','$bname', '$amount','$invoice','$due_date','$desc1','$created_date','$entry_time','$i_p','Requested',13,'$c_type','$invdate','','$cust_name','$checqno','$cheq_amount','$tamount','$form_name')") or die (mysql_error());
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="block">
                                ...
                                <form action="f13-rec-post-date-cheq-req-form" method="post" enctype="multipart/form-data" id="testconfirmJQ" name="testconfirmJQ">
  ...
  <tr>
    ...
    <td width="138" style="vertical-align:middle;">Cheque #</td>
    <td width="144"><input type="text" name="checqno" id="checqno" class="form-control" style="" required/></td>
    <td width="129">Cheque Amount</td>
    <td width="144"><input type="text" name="cheq_amount" id="cheq_amount" class="form-control" style="" required/></td>
  </tr>
  <tr>
    <td valign="middle" style="vertical-align:middle;">Due Date</td>
    <td><input type="text" id="duedate" name="duedate" class="form-control input-datepicker" data-date-format="yyyy/mm/dd" placeholder="yyyy/mm/dd" required ></td>
    <td style="vertical-align:middle;">Invoice #</td>
    <td>
	
	<input type="text" name="invoice" id="invoice" class="form-control" style="" required/></td>
    <td>Invoice Date</td>
  ...
  <tr>
    ...
    <td><input type="text" name="invamount" id="invamount" class="form-control" style="" required/></td>
...
<div id="jq-dialog" title="Verify Form ">
  ...
  <tr>
    ...
    <td width="138" style="vertical-align:middle;">Cheque #</td>
    <td width="144"><span id="checqno"><strong></strong></span></td>
    <td width="129">Cheque Amount</td>
    <td width="144"><span id="cheq_amount"><strong></strong></span></td>
  </tr>
  <tr>
    <td valign="middle" style="vertical-align:middle;">Due Date</td>
    ...
    <td>Invoice Date</td>
    <td><span id="reqno"><strong></strong></span></td>
  </tr>
  <tr>
    <td valign="middle" style="vertical-align:middle;">Invoice Amount</td>
    <td><span id="invamount"><strong></strong></span></td>
    <td style="vertical-align:middle;">&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
