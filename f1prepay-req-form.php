...
$r=rand();
	...
	$form_name='Prepayment Request Form';
    ...
    $insform=mysql_query("insert into formsdata (id,username,ref,created_date,benif_name,amount,invoice,due_date,description,entry_date,entry_time,Ip,status,formid,benif_bank_ac,benif_bank_name,payc,inv_date,form_name) values
	                                ('','$requester','$ref','$created_date','$bname', '$amount','$invoice','$due_date','$desc1','$created_date','$entry_time','$i_p','Requested',1,'$bban','$bbn','$pay_c','$invdate','$form_name')") or die (mysql_error());
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="block">
                                ...
                                <form action="f1prepay-req-form" method="post" enctype="multipart/form-data" id="testconfirmJQ" name="testconfirmJQ">
...
<td colspan="4">
<div class="col-sm-3">
<select name="dept" class="form-control" style="border:1px solid red;" required readonly='readonly'>
<?php /*$qu=mysql_query("select distinct dept from users order by dept");$qu1=mysql_query("select distinct dept from users where username='$user_name'");
$qur1=mysql_fetch_array($qu1); 
while($qur=mysql_fetch_array($qu)){?>
<option value="<?php echo $qur['dept'];?>" <?php if ($qur1['dept']==$qur['dept']){echo 'selected="selected"';}?> ><?php echo $qur['dept'];?></option>
<?php }*/?>
</select>
</div>
</td>
...
-->
  <tr>
    ...
    <td colspan="3"><input type="text" name="bban" id="bban" class="form-control" requierd></td>
   </tr>
  <tr>
    <td  width="130" valign="middle" style="vertical-align:middle;">Beneficiary Bank Name</td>
    <td width="154"><input type="text" name="bbn" id="bbn" class="form-control" required></td>
    <td style="vertical-align:middle;" width="140">Payment Currency</td>
    <td width="167"><label>
    ...
    <td width="182"><span style="vertical-align:middle;">Amount</span></td>
  ...
  <tr>
    ...
    <td><input type="text" name="invoiceno" id="invoiceno" class="form-control" required></td>
    <td style="vertical-align:middle;">Invoice Date</td>
    <td><input type="text" id="invdate" name="invdate" class="form-control input-datepicker" data-date-format="dd/mm/yyyy" placeholder="yyyy/mm/dd" required>
...
<script>
            $(function(){
                ...
                $('form#testconfirmJQ').submit(function(e){
					...
					$("span#invoiceno strong").html($("input#invoiceno").val());
...
<table class="table table-bordered" width="951" border="1">
  <tr>
    <td width="160"  valign="middle" style="vertical-align:middle;"><span class="style2">Beneficiary Name</span></td>
    <td><span id="bname"><strong></strong></span></td>
    <td colspan="2"  style="vertical-align:middle;">Beneficiary Bank Account Number</td>
    <td colspan="2"><span id="bban"><strong></strong></span></td>
  </tr>
  <tr>
    <td  width="160" valign="middle" style="vertical-align:middle;">Beneficiary Bank Name</td>
    <td width="154"><span id="bbn"><strong></strong></span></td>
    <td style="vertical-align:middle;" width="160">Payment Currency</td>
    <td width="167"><span id="payc"><strong></strong></span></td>
    <td width="182"><span style="vertical-align:middle;">Amount (AED)</span></td>
    <td width="176"><span id="amount"><strong></strong></span></td>
  </tr>
  <tr>
    <td style="vertical-align:middle;">Invoice #</td>
    <td><span id="invoiceno"><strong></strong></span></td>
    <td style="vertical-align:middle;">Invoice Date</td>
