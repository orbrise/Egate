                ...
                <div id="page-content">
                    ...
                    <div class="content-header">
                        <div class="header-section">
                            <h1>
                                <i class="gi gi-notes_2"></i>Petty Cash Payment Request Form<br/><small></small>
                            </h1>
                        </div>
                    </div>
                    <ul class="breadcrumb breadcrumb-top">
                        <li><a href="finance.php">Finance</a></li>
                        <li><a href="">Petty Cash Payment Request Form</a></li>
                    </ul>
...
$r=rand();
	...
	$form_name='Petty Cash Payment Request Form';
	$i_p=$_SERVER['REMOTE_ADDR'];
    $entry_time=date('h:i;s');
    $unixtime=time();
    $subject=$user_name.' Generate a Request Req# '. $ref;
    
    $insform=mysql_query("insert into formsdata (id,username,ref,created_date,benif_name,amount,invoice,due_date,description,entry_date,entry_time,Ip,status,formid,inv_date,form_name) values
	                                ('','$requester','$ref','$created_date','$bname', '$amount','$invoice','$due_date','$desc1','$created_date','$entry_time','$i_p','Requested',5,'$invdate','$form_name')") or die (mysql_error());
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="block">
                                ...
                                <form action="f5petty-cash-req-form" method="post" enctype="multipart/form-data" id="testconfirmJQ" name="testconfirmJQ">
  ...
  <tr>
    ...
    <td ><b></b></td>
                                   ...
                                   <table class="table table-bordered" width="641" border="1">
  ...
  <tr>
    <td  width="100" valign="middle" style="vertical-align:middle;">Batch / Invoice #</td>
    <td width="178"><input type="text" name="invoice"  id="invoice" class="form-control" style="" required/></td>
    <td style="vertical-align:middle;" width="100">Batch / Invoice Date</td>
    <td width="80">
	<input type="text" id="invdate" name="invdate" class="form-control input-datepicker" data-date-format="yyyy/mm/dd" placeholder="yyyy/mm/dd" required >
...
<table class="table table-bordered" width="641" border="1">
  <tr>
    <td valign="middle" style="vertical-align:middle;">Beneficiary Name</td>
    <td><span id="bname"><strong></strong></span></td>
    <td style="vertical-align:middle;">Amount (AED)</td>
    <td><span id="amount"><strong></strong></span></td>
   </tr>
  <tr>
    <td  width="133" valign="middle" style="vertical-align:middle;">Batch / Invoice #</td>
    <td width="178"><span id="invoice"><strong></strong></span></td>
    <td style="vertical-align:middle;" width="141">Batch / Invoice Date</td>
    <td width="161"><label>
     <span id="invdate"><strong></strong></span>
    </label></td>
   </tr>
</table>
