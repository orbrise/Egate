                ...
                <div id="page-content">
                    ...
                    <div class="content-header">
                        <div class="header-section">
                            <h1>
                                <i class="gi gi-notes_2"></i>Temporary Petty Cash Payment Request Form<br/><small></small>
                            </h1>
                        </div>
                    </div>
                    <ul class="breadcrumb breadcrumb-top">
                        <li><a href="finance.php">Finance</a></li>
                        <li><a href="">Temporary Petty Cash Payment Request Form</a></li>
                    </ul>
...
$r=rand();
    ...
    $insform=mysql_query("insert into formsdata (id,username,ref,created_date,benif_name,amount,invoice,due_date,description,entry_date,entry_time,Ip,status,formid,form_name) values
	                                ('','$requester','$ref','$created_date','$bname', '$amount','$invoice','$due_date','$desc1','$created_date','$entry_time','$ip','Requested',3,'$form_name')") or die (mysql_error());
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="block">
                                ...
                                <form action="f3tem-petty-cash-req-form" method="post" enctype="multipart/form-data" id="testconfirmJQ" name="testconfirmJQ">
  ...
  <tr>
    ...
    <td width="230"><input type="text" name="bname" id="bname" class="form-control" required></td>
    <td style="vertical-align:middle;" width="144">Amount</td>
    <td width="308"><input type="number" pattern="\d+(\.\d{2})?" name="amount" id="amount" class="form-control" required></td>
  </tr>
  <tr>
...
<table class="table table-bordered" width="700" border="1">
  <tr>
    <td  width="144" valign="middle" style="vertical-align:middle;"><span class="style2">Beneficiary Name</span></td>
    <td width="230"><span id="bname"><strong></strong></span></td>
    <td style="vertical-align:middle;" width="144">Amount (AED)</td>
    <td width="308"><span id="amount"><strong></strong></span></td>
  </tr>
  <tr>
    <td style="vertical-align:middle;">Settlement Due date</td>
