...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Login | E-Gate Application</title>
  ...
  <!-- <img src="img/placeholders/backgrounds/login_full_bg1.jpg" alt="Login Full Background" class="full-bg animation-pulseSlow"> 
...
$row=mysql_fetch_array($check); $usern=$row['username']; $pass=$row['password']; $user_id=$row['user_id'];

if ($usern==$username and $password==$pass) {
 session_start();
...
?>
        ...
        <div id="login-container" class="animation-fadeIn">
            ...
            <div class="login-title text-center">
                <h1><strong>E-Gate Application by - ADCI Group</strong><br><small>Please <strong>Login</strong> With <strong>ADCI Credentials</strong></small></h1>
                <?php if(isset($_POST['posted'])) { echo '<h5 class="alert alert-danger">'.$error.'</h5>'; } ?>
            </div>
            <!-- END Login Title -->
