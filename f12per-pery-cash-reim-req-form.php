                ...
                <div id="page-content">
                    ...
                    <div class="content-header">
                        <div class="header-section">
                            <h1>
                                <i class="gi gi-notes_2"></i>Permenant Petty Cash Reimbursement Request Form<br/><small></small>
                            </h1>
                        </div>
                    </div>
                    <ul class="breadcrumb breadcrumb-top">
                        <li><a href="finance.php">Finance</a></li>
                        <li><a href="">Permenant Petty Cash Reimbursement Request Form</a></li>
                    </ul>
...
$r=rand();
	...
	$reim_amount=clean($_POST['reim_amount']);
	$sur_reason=clean($_POST['sur_reason']);
	$num_notes=strlen($notes);
	$desc1=clean($_POST['description']);
	$pc=$_SERVER['REMOTE_ADDR'];
	$form_name='Permenant Petty Cash Reimbursement Request Form';
	$i_p=$_SERVER['REMOTE_ADDR'];
    $entry_time=date('h:i;s');
    $unixtime=time();
    $subject=$user_name.' Generate a Request Req# '. $ref;
    
    $insform=mysql_query("insert into formsdata (id,username,ref,created_date,benif_name,amount,invoice,due_date,description,entry_date,entry_time,Ip,status,formid,payc,total_cost,per_prety_cash_reqno,tem_petty_cash_amount,Reimbur_amt,form_name) values
	                                ('','$requester','$ref','$created_date','$bname', '$amount','$invoice','$due_date','$desc1','$created_date','$entry_time','$i_p','Requested',12,'$c_type','$tamount','$reqno','$amount','$reim_amount','$form_name')") or die (mysql_error());
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="block">
                                ...
                                <form action="f12per-pery-cash-reim-req-form" method="post" enctype="multipart/form-data" id="testconfirmJQ" name="testconfirmJQ">
  ...
  <tr>
    ...
    <td width="138" style="vertical-align:middle;">Temporary Petty Cash  Amount</td>
    <td width="144"><input type="text" name="amount" id="amount" class="form-control" style="" required/></td>
    <td width="129">Total Costs </td>
    <td width="144"><input type="text" name="total_amount" id="total_amount" class="form-control" style="" required/></td>
  </tr>
  <tr>
    <td  width="224" valign="middle" style="vertical-align:middle;">Reimbursement Amount</td>
    <td colspan="5"><input type="text" name="reim_amount" id="reim_amount" class="form-control" style="" required/></td>
   </tr>
</table>
...
<script>
            $(function(){
                ...
                $('form#testconfirmJQ').submit(function(e){
					...
					$("span#reim_amount strong").html($("input#reim_amount").val());
...
<div id="jq-dialog" title="Verify Form ">
  ...
  <tr>
    ...
    <td width="129">Total Costs </td>
    <td width="144"><span id="total_amount"><strong></strong></span></td>
  </tr>
  <tr>
    <td  width="224" valign="middle" style="vertical-align:middle;">Reimbursement Amount</td>
    <td colspan="5"><span id="reim_amount"><strong></strong></span></td>
   </tr>
</table>
