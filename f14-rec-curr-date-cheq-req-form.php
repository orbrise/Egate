                ...
                <div id="page-content">
                    ...
                    <div class="content-header">
                        <div class="header-section">
                            <h1>
                                <i class="gi gi-notes_2"></i> Receipts -Current Date Cheque Request Form<br/><small></small>
                            </h1>
                        </div>
                    </div>
                    <ul class="breadcrumb breadcrumb-top">
                        <li><a href="finance.php">Finance</a></li>
                        <li><a href=""> Receipts -Current Date Cheque Request Form</a></li>
                    </ul>
...
$r=rand();
	...
	$form_name='Receipts -Current Date Cheque Request Form';
    ...
    $insform=mysql_query("insert into formsdata (id,username,ref,created_date,benif_name,amount,invoice,due_date,description,entry_date,entry_time,Ip,status,formid,payc,inv_date,total_cost,cus_name,check_no,check_amount,inv_amt,form_name) values
	                                ('','$requester','$ref','$created_date','$bname', '$amount','$invoice','$due_date','$desc1','$created_date','$entry_time','$i_p','Requested',14,'$c_type','$invdate','','$cust_name','$checqno','$cheq_amount','$tamount','$form_name')") or die (mysql_error());
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="block">
                                ...
                                <form action="f14-rec-curr-date-cheq-req-form" method="post" enctype="multipart/form-data" id="testconfirmJQ" name="testconfirmJQ">
  ...
  <tr>
    <td valign="middle" style="vertical-align:middle;">Invoice #</td>
    <td><input type="text" name="invoice" id="invoice" class="form-control" style="" required/></td>
