                ...
                <div id="page-content">
                    ...
                    <div class="content-header">
                        <div class="header-section">
                            <h1>
                                <i class="gi gi-notes_2"></i>Sales Invoice Request Form<br/><small></small>
                            </h1>
                        </div>
                    </div>
                    <ul class="breadcrumb breadcrumb-top">
                        <li><a href="finance.php">Finance</a></li>
                        <li><a href="">Sales Invoice Request Form</a></li>
                    </ul>
...
$r=rand();
	...
	$contno=clean($_POST['contno']);
	$inv_amount=clean($_POST['invamount']);
	$due_date=date('Y-m-d',strtotime($_POST['duedate']));
	
	$num_notes=strlen($notes);
	$desc1=clean($_POST['description']);
	$pc=$_SERVER['REMOTE_ADDR'];
	$form_name='Sales Invoice Request Form';
	$i_p=$_SERVER['REMOTE_ADDR'];
    $entry_time=date('h:i;s');
    $unixtime=time();
    $subject=$user_name.' Generate a Request Req# '. $ref;
    
    $insform=mysql_query("insert into formsdata (id,username,ref,created_date,benif_name,amount,invoice,due_date,description,entry_date,entry_time,Ip,status,formid,contract_po,cus_name,inv_amt,form_name) values
	                                ('','$requester','$ref','$created_date','$bname', '$amount','$invoice','$due_date','$desc1','$created_date','$entry_time','$i_p','Requested',18,'$contno','$cust_name','$inv_amount','$form_name')") or die (mysql_error());
...
foreach($apr_name as $aprs){
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="block">
                                ...
                                <form action="f18-sale-inv-req-form" method="post" enctype="multipart/form-data" id="testconfirmJQ" name="testconfirmJQ">
  ...
  <tr>
    ...
    <td width="138" style="vertical-align:middle;">Contract/PO/WO No</td>
    <td width="144"><input type="text" name="contno" id="contno" class="form-control" style="" required/></td>
    <td width="129" style="vertical-align:middle;">Inv Amount</td>
    <td width="144"><input type="text" name="invamount"  id="invamount" class="form-control" style="" required/></td>
  </tr>
  <tr>
...
<script>
            $(function(){
                ...
                $('form#testconfirmJQ').submit(function(e){
                	e.preventDefault();
                     $("span#cus_name strong").html($("input#cust_name").val());
					
					$("span#invamount strong").html($("input#invamount").val());
					$("span#contno strong").html($("input#contno").val());
...
<div id="jq-dialog" title="Verify Form ">
  ...
  <tr>
    <td width="224" valign="middle" style="vertical-align:middle;">Customer Name</td>
    <td width="150"><label>
    <span id="cus_name"><strong></strong></span>
    </label></td>
    <td width="138" style="vertical-align:middle;">Contract/PO/WO No</td>
    <td width="144"><span id="contno"><strong></strong></span></td>
    <td width="129" style="vertical-align:middle;">Inv Amount</td>
    <td width="144"><span id="invamount"><strong></strong></span></td>
  </tr>
  <tr>
    <td valign="middle" style="vertical-align:middle;">Due Date</td>
