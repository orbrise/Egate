                ...
                <div id="page-content">
                    ...
                    <div class="content-header">
                        <div class="header-section">
                            <h1>
                                <i class="gi gi-notes_2"></i>Prepayment Settlement Request Form<br/><small></small>
                            </h1>
                        </div>
                    </div>
                    <ul class="breadcrumb breadcrumb-top">
                        <li><a href="finance.php">Finance</a></li>
                        <li><a href="">Prepayment Settlement Request Form</a></li>
                    </ul>
...
$r=rand();
	...
	$form_name='Prepayment Settlement Request Form';
	$i_p=$_SERVER['REMOTE_ADDR'];
    $entry_time=date('h:i;s');
    $unixtime=time();
    $subject=$user_name.' Generate a Request Req# '. $ref;
    
    $insform=mysql_query("insert into formsdata (id,username,ref,created_date,benif_name,amount,invoice,due_date,description,entry_date,entry_time,Ip,status,formid,payc,prepay_req_no,prepay_amount,total_cost,diposit_amount,suplus_amount,perc_increase_prepay,form_name) values
	                                ('','$requester','$ref','$created_date','$bname', '$amount','$invoice','$due_date','$desc1','$created_date','$entry_time','$i_p','Requested',9,'$c_type','$reqno',$amount,'$tamount','$depoamount','$suramount','$inc_amount','$form_name')") or die (mysql_error());
...
foreach($apr_name as $aprs){
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="block">
                                ...
                                <form action="f9pre-pay-set-req-form" method="post" enctype="multipart/form-data" id="testconfirmJQ" name="testconfirmJQ">
  ...
  <tr>
    <td valign="middle" style="vertical-align:middle;">Prepayment Request NO. </td>
    <td width="150">
    <input type="text" name="reqno" id="reqno" class="form-control" style="" required/>
    </td>
    <td width="138" style="vertical-align:middle;">Prepayment Currency</td>
    <td colspan="3"><select name="c_type" id="c_type" class="form-control" required>
  ...
  <tr>
    <td  width="165" valign="middle" style="vertical-align:middle;">Prepayment Amount</td>
  ...
  <tr>
    ...
    <td width="125">% Increase of prepayment</td>
...
<table class="table table-bordered" width="906" border="1">
  <tr>
    ...
    <td width="138" style="vertical-align:middle;">Prepayment Currency</td>
    <td colspan="3"><span id="c_type"><strong></strong></span></td>
  </tr>
  <tr>
    <td  width="165" valign="middle" style="vertical-align:middle;">Payment Amount</td>
