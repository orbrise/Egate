                ...
                <div id="page-content">
                    ...
                    <div class="content-header">
                        <div class="header-section">
                            <h1>
                                <i class="gi gi-notes_2"></i>Temporary Petty Cash Settlement Request Form<br/><small></small>
                            </h1>
                        </div>
                    </div>
                    <ul class="breadcrumb breadcrumb-top">
                        <li><a href="finance.php">Finance</a></li>
                        <li><a href="">Temporary Petty Cash Settlement Request Form</a></li>
                    </ul>
...
$r=rand();
	...
	$form_name='Temporary Petty Cash Settlement Request Form';
    ...
    $insform=mysql_query("insert into formsdata (id,username,ref,created_date,benif_name,amount,invoice,due_date,description,entry_date,entry_time,Ip,status,formid,payc,prepay_req_no,prepay_amount,total_cost,diposit_amount,suplus_amount,perc_increase_prepay,reason_surplus,form_name) values
	                                ('','$requester','$ref','$created_date','$bname', '$amount','$invoice','$due_date','$desc1','$created_date','$entry_time','$i_p','Requested',11,'$c_type','$reqno',$amount,'$tamount','$depoamount','$suramount','$inc_amount','$sur_reason','$form_name')") or die (mysql_error());
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="block">
                                ...
                                <form action="f11tem-pety-cash-set-req-form" method="post" enctype="multipart/form-data" id="testconfirmJQ" name="testconfirmJQ">
  ...
  <tr>
    <td valign="middle" style="vertical-align:middle;">Temporary Petty Cash Request NO. </td>
    <td width="150">
  ...
  <tr>
    <td  width="224" valign="middle" style="vertical-align:middle;">Temporary Petty Cash  Amount</td>
  ...
  <tr>
    ...
    <td width="129">% Increase of <span style="vertical-align:middle;">Temporary</span>Petty Cash</td>
...
<table class="table table-bordered" width="969" border="1">
  ...
  <tr>
    ...
    <td width="129">% Increase of <span style="vertical-align:middle;">Temporary</span>prepayment</td>
