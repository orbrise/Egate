                ...
                <div id="page-content">
                    ...
                    <div class="content-header">
                        <div class="header-section">
                            <h1>
                                <i class="gi gi-notes_2"></i>Permanent Petty Cash Payment Request Form<br/><small></small>
                            </h1>
                        </div>
                    </div>
                    <ul class="breadcrumb breadcrumb-top">
                        <li><a href="finance.php">Finance</a></li>
                        <li><a href="">Permanent Petty Cash Payment Request Form</a></li>
                    </ul>
...
$r=rand();
	...
	$form_name='Permanent Petty Cash Request Form';
	$i_p=$_SERVER['REMOTE_ADDR'];
    $entry_time=date('h:i;s');
    $unixtime=time();
    $subject=$user_name.' Generate a Request Req# '. $ref;
    
    $insform=mysql_query("insert into formsdata (id,username,ref,created_date,benif_name,amount,invoice,due_date,description,entry_date,entry_time,Ip,status,formid,form_name) values
	                                ('','$requester','$ref','$created_date','$bname', '$amount','$invoice','$due_date','$desc1','$created_date','$entry_time','$i_p','Requested',2,'$form_name')") or die (mysql_error());
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="block">
                                ...
                                <form action="f2per-petty-cash-pay-req" method="post" enctype="multipart/form-data" id="testconfirmJQ" name="testconfirmJQ">
...
<table class="table table-bordered" width="581" border="1">

  <tr>
    <td width="70" valign="middle" style="vertical-align:middle;"><span class="style2">Beneficiary Name</span></td>
    <td width="100"><input type="text" id="bname" name="bname" class="form-control" required></td>
    <td width="50" style="vertical-align:middle;">Amount</td>
    <td width="167"><input type="text" id="amount" name="amount" class="form-control" required/></td>
   </tr>
</table>
Description:<br>
<textarea class="form-control" name="description" id="description" cols="5" rows="10" required></textarea>
<br>
...
<div id="jq-dialog" title="Verify Form ">
	...
	<table class="table table-bordered" width="581" border="1">
  <tr>
    <td width="130" valign="middle" style="vertical-align:middle;"><span class="style2">Beneficiary Name</span></td>
    <td width="154"><span id="bname"><strong></strong></span></td>
    <td width="140" style="vertical-align:middle;">Amount (AED)</td>
    <td width="167"><span id="amount"><strong></strong></span></td>
   </tr>
</table>
